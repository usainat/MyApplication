...
import com.etrack.myapplication.adapter.SalesSelectAdapter
...
class SalesListFragment(mContext: Context, refreshInterface: UpdateList) : DialogFragment() {

    private var mProductSelectListAdapter: SalesSelectAdapter? = null
...
//        this.productList = productList
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        if (rvProductList != null) {
            mProductSelectListAdapter = SalesSelectAdapter(mContext!!)
