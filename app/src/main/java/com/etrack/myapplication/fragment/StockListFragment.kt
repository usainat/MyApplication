...
import com.etrack.myapplication.adapter.StockSelectAdapter
...
class StockListFragment(mContext: Context, refreshInterface: UpdateList) : DialogFragment() {

    private var mProductSelectListAdapter: StockSelectAdapter? = null
...
//        this.productList = productList
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        if (rvProductList != null) {
            mProductSelectListAdapter = StockSelectAdapter(mContext!!)
