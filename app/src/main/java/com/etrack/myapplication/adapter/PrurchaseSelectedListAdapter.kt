...
class PrurchaseSelectedListAdapter(private val mContext: Context, private val refreshInterface: UpdateList) : RecyclerView.Adapter<PrurchaseSelectedListAdapter.MyViewHolder>() {
